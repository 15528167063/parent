...
import com.hzkc.parent.fragment.appmanage.BlackAppFragment;
import com.hzkc.parent.fragment.appmanage.TeQuanFragment;
import com.hzkc.parent.fragment.appmanage.TotleAppFragment;
 ...
 * 管控设置
 */
public class AppManageActivity extends BaseActivity implements View.OnClickListener, OnTabSelectListener {
    ...
    private void initDatas() {
        ...
        mFragments.add(TeQuanFragment.getInstance(1));
        mFragments.add(BlackAppFragment.getInstance(2));
        setTab();
    }
    private int flag = 0;
    private void setTab() {
...
//            showPop();
    ...
    public void showPop() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.deteledialogs, null);
