...
import static com.hzkc.parent.R.id.iv_refresh;
import static com.hzkc.parent.R.id.tv_detail_address;


public class ChildLocationActivity extends BaseActivity implements View.OnClickListener {
...
//                        ToastUtils.showToast(ChildLocationActivity.this,"定位失败，请稍后再试");
    ...
    private void initView() {
        ...
        tvDetailAddress= (TextView) findViewById(tv_detail_address);
        ...
        ivRefresh = (ImageView) findViewById(iv_refresh);
