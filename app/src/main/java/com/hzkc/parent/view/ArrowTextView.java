...
public class ArrowTextView extends TextView {
    ...
    private void ini(Context context, AttributeSet attrs) {
        ...
        radius = typedArray.getDimension(R.styleable.ArrowTextView_sssss, 0);
        arrowWidth = typedArray.getDimension(R.styleable.ArrowTextView_ddddd, 0);
        arrowHeight = typedArray.getDimension(R.styleable.ArrowTextView_ffff, 0);
        color = typedArray.getColor(R.styleable.ArrowTextView_gggg, Color.RED);
    }
