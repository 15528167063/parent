...
public class SoliderFragmentListAdapter extends BaseAdapter {
    ...
    public SoliderFragmentListAdapter(List<MineItemBean> minelist, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // 导入布局并赋值给convertview
            convertView = inflater.inflate(R.layout.item_mine_lists, null);
