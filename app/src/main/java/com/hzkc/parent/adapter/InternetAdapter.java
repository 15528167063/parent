...
public class InternetAdapter extends RecyclerView.Adapter<InternetAdapter.MyViewHolder> implements View.OnClickListener {
    private Activity mActivity;
    private List<InternetItemBean> mList;
    private OnRecyclerViewItemClickListener mListener = null;

    public InternetAdapter(Activity mActivity, List<InternetItemBean> mList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mActivity).inflate(R.layout.item_recyclerview, parent, false);
