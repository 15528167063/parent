...
public class InstallAdapter extends BaseAdapter {
    ...
    // 构造器
    public InstallAdapter(List<AppDataBean> planlist, Context context, String parentUUID, String childUUID) {
    ...
    @Override
    public AppDataBean getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // 导入布局并赋值给convertview
            convertView = inflater.inflate(R.layout.item_app_list2, null);
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        InstallAdapter.isSelected = isSelected;
    }
