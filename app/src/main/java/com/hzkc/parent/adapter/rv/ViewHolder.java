package com.hzkc.parent.adapter.rv;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setmultiImagView(int viewId, List<PhotoInfo> imageUrls) {
        MultiImageView multiImagView = getView(viewId);
        multiImagView.setList(imageUrls);
        return this;
    }
