...
public class MyAppWhiteAdapter extends BaseAdapter {
    // 填充数据的list
    ...
    // 构造器
    public MyAppWhiteAdapter(List<AppDataBean> planlist, Context context) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        MyAppWhiteAdapter.isSelected = isSelected;
    }
