...
public class TeachBean2 implements IMulTypeHelper {
    ...
    public TeachBean2(String posterId, List<String> imageUrls, String title, String url, String publishDateStr) {
    ...
    public void onBind(ViewHolder holder) {
        ...
        for (int i = 0; i < imageUrls.size(); i++) {
            imageDatas.add(new PhotoInfo(imageUrls.get(i)));
        }
