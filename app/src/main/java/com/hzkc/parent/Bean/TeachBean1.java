...
public class TeachBean1 implements IMulTypeHelper {
    ...
    public TeachBean1(String posterId, List<String> imageUrls, String title, String url, String publishDateStr) {
    ...
    public void onBind(ViewHolder holder) {
        ...
        Glide.with(holder.itemView.getContext()).load(imageUrls.get(0)).into((ImageView) holder.getView(R.id.iv_img));
    }
}
