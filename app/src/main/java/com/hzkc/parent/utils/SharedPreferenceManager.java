...
public class SharedPreferenceManager {
     ...
     * 当前用户名称
     */
    private static String CURRENT_USER_USERNAME = "current_user_username";
    /**
     * 保存当前用id
     */
     ...
     * 当前用户昵称
     */
    private static String CURRENT_USER_NICK = "current_user_nick";
    /**
     * 用户头像
     */
    private static String CURRENT_USER_AVATAR = "current_user_avatar";
    ...
    private SharedPreferenceManager(Context cxt) {
    ...
    public static synchronized void init(Context cxt) {
        if (mPreferencemManager == null) {
            mPreferencemManager = new SharedPreferenceManager(cxt);
        }
    }
    ...
    public void setCurrentUserNick(String nick) {
        editor.putString(CURRENT_USER_NICK, nick);
        editor.apply();
    }

    public void setCurrentUserAvatar(String avatar) {
        editor.putString(CURRENT_USER_AVATAR, avatar);
        editor.apply();
    }

    public String getCurrentUserNick() {
        return mSharedPreferences.getString(CURRENT_USER_NICK, null);
    }

    public String getCurrentUserAvatar() {
        return mSharedPreferences.getString(CURRENT_USER_AVATAR, null);
    }
    ...
    public String getCurrentUsername() {
        return mSharedPreferences.getString(CURRENT_USER_USERNAME, null);
    }
