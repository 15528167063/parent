...
public class TransformUtil {
    ...
    public static int dip2px(float dpValue) {
        float scale = MyApplication.getAppContext().getResources()
     ...
     * @return 替换完成后的字符串
     */
    public static String replaceEmoji(String string, String rString) {
