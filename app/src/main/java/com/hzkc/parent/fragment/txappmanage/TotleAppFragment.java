...
import com.hzkc.parent.fragment.txappmanage.adapter.TotleAppAdapter;
...
//        hd.postDelayed(runnable, 8000);
                ...
                if (map.get(i)) {
                    ...
                    if (findApp != null) {
                        if(blackclick){
                            ...
                            findApp.setAppwhitelist(CmdCommon.CMD_FLAG_Te);
                        }
                        dao.update(findApp);
                        ((AppManageLastActivity)getActivity()).addDatas(findApp);
                    }
                }
    ...
    private void initAppList() {
        ...
        adapter = new TotleAppAdapter(this.list, getActivity(),parentUUID,childUUID);
